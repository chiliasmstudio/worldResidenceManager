...
public class AddFreeSize {

    public static int addFreeSize(CommandContext<CommandSourceStack> ctx) throws CommandSyntaxException {
        ...
        WorldResidenceManager.worldResidenceManager.sqlDatabase.addFreeSize(target.getUniqueId(),maxsize);
