...
public class ReduceFreeSize {

    public static int reduceFreeSize(CommandContext<CommandSourceStack> ctx) throws CommandSyntaxException {
        ...
        WorldResidenceManager.worldResidenceManager.sqlDatabase.reduceFreeSize(target.getUniqueId(),maxsize);
        sender.sendRichMessage(target.getName()+ " free size now is: " + WorldResidenceManager.worldResidenceManager.sqlDatabase.getFreeSize(target.getUniqueId()));
